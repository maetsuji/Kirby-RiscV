...
endEcall.pula:	#addi    sp, sp, 264
		...
		csrr 	s8, uepc 	# le o valor de EPC salvo no registrador uepc (reg 65)
		addi 	s8, s8, 4	# soma 4 para obter a instrucao seguinte ao ecall
		csrw 	s8, uepc	# coloca no registrador uepc
		lw     x24, 92(sp)	# le s8 original
		addi   sp, sp, 264	# libera espaço da pilha
